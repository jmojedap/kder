...
<form accept-charset="utf-8" id="item_form" @submit.prevent="send_form">
    ...
    <div class="form-group row">
        <div class="col-sm-8 offset-4">
            <button class="btn btn-block" v-bind:class="app_state.button_class" type="submit">
    ...
    <div class="form-group row">
        <label for="cod" class="col-md-4 control-label">
    ...
    <div class="form-group row">
        <label for="item_name" class="col-md-4 control-label">
    ...
    <div class="form-group row">
        <label for="description" class="col-md-4 control-label">
            <span class="float-rigth">Descripción</span>
        </label>
        <div class="col-md-8">
            <textarea
    ...
    <div class="form-group row">
        <label for="item_group" class="col-md-4 control-label">
            <span class="float-rigth">Grupo</span>
        </label>
        <div class="col-md-8">
            <input
                id="field-item_group"
    ...
    <div class="form-group row">
        <label for="filters" class="col-md-4 control-label">
            <span class="float-rigth">Filtros</span>
        </label>
        <div class="col-md-8">
            <input
                id="field-filtro"
    ...
    <div class="form-group row">
        <label for="abbreviation" class="col-md-4 control-label">
            <span class="float-rigth">Abreviatura</span>
        </label>
        <div class="col-md-8">
            <input
    ...
    <div class="form-group row">
        <label for="parent_id" class="col-sm-4 control-label">Padre</label>
        <div class="col-sm-8">
            <?= form_dropdown('parent_id', $options_parent, '', 'class="form-control" v-model="form_values.parent_id"') ?>
        </div>
    </div>

    <div class="form-group row">
        <label for="long_name" class="col-md-4 control-label">
    ...
    <div class="form-group row">
        <label for="short_name" class="col-md-4 control-label">
