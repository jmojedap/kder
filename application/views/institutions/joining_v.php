                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input
                                ...
                                title="Escriba el nombre de una institución"
                                v-model="term"
                                v-on:change="search_institutions"
                                >
                        </div>
                    </div>
                </form>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <select name="role" class="form-control" v-model="role">
                            ...
                            <option v-for="option_role in roles" v-bind:value="option_role.id">{{ option_role.title }}</option>
                        </select>
                    </div>
                </div>
...
<script>
    new Vue({
        ...
        data: {
            roles: [
                {'id': '013', 'title': 'Administrativo'},
                {'id': '015', 'title': 'Profesor'},
                {'id': '021', 'title': 'Padre/Madre de Familia'}
            ],
            role: '',
            type: 0,
            term: '',
        ...
        methods: {
            ...
            join: function(){
                ...
                .then(response => {
                    if ( response.data.status == 1 ) { this.set_sended(); }
                })
                .catch(function (error) {
                    console.log(error);
                });
